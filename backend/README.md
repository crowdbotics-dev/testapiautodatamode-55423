...
## Project Structure
    ...
    ├── testapiautodatamode_55423  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamode_55423`
...
2. Clone this repo and `cd testapiautodatamode_55423`
